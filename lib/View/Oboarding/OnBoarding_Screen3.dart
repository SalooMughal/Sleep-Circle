...
class Oboarding_Screen3 extends StatefulWidget {
  const Oboarding_Screen3({super.key});

  @override
  State<Oboarding_Screen3> createState() => _Oboarding_Screen2State();
}

class _Oboarding_Screen2State extends State<Oboarding_Screen3> {
  int? selectedIndex;
