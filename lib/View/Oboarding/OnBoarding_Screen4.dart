...
import 'package:demoapp/View/Oboarding/OnBoarding_Screen6.dart';
...
class Oboarding_Screen4 extends StatefulWidget {
  const Oboarding_Screen4({super.key});

  @override
  State<Oboarding_Screen4> createState() => _Oboarding_Screen2State();
}

class _Oboarding_Screen2State extends State<Oboarding_Screen4> {
  int? selectedIndex;
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextButton( // Changed from GestureDetector to TextButton
                              onPressed: (){
                                Get.to(const Oboarding_Screen5());
                              },
                              child: const Text(
                                'SKIP',
                                style: TextStyle(
