...
class Daily_Picks_Detail extends StatefulWidget {
  const Daily_Picks_Detail({super.key});

  @override
  State<Daily_Picks_Detail> createState() => _Daily_Picks_DetailState();
}

class _Daily_Picks_DetailState extends State<Daily_Picks_Detail> {
